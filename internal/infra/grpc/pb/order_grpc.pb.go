...
type OrderServiceClient interface {
	...
	ListOrder(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListOrdersResponse, error)
}
...
func (c *orderServiceClient) ListOrder(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListOrdersResponse, error) {
...
type OrderServiceServer interface {
	...
	ListOrder(context.Context, *Blank) (*ListOrdersResponse, error)
...
func (UnimplementedOrderServiceServer) ListOrder(context.Context, *Blank) (*ListOrdersResponse, error) {
